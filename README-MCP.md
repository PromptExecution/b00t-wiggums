...
**Tools:**
- `run_ralph_iteration(agent, max_iterations)` - Run Ralph for N iterations
- `get_ralph_status()` - Get current execution status from progress.txt
- `get_task_status()` - Get TaskMaster completion metrics

**Resources:**
- `ralph://tasks` - Current TaskMaster tasks as JSON
